...
<<<<<<< HEAD
  },
  {
    ...
    slug: 'vagera-tech',
    username: 'vagera_ai',
    displayName: 'Vagera Tech',
    bio: 'Automating everything from web scrapers to AI agents. Open sourcing my internal tools.',
    profilePic: 'https://picsum.photos/seed/vagera/200/200',
    isVerified: true,
    niche: 'Automation',
    isHidden: false,
    followersCount: 5600,
